H1 Sortowanie babelkowe

<p>Przez prostą zamianę – bąbelkowe (Bubble Sort) – BbS</p>
...
<p> Przez proste wstawianie (Insertion Sort) – IS
Algorytm ten działa w taki sposób w jaki ludzie często porządkują talię kart. Zaczynamy od 
...
h1 Sortowanie proste przez wybiernie
<p>Przez proste wybieranie/wymianę (Selection Sort) 
Na  początku  szukany  jest  najmniejszy  element.  Po  jego  znalezieniu  jest  on  zamieniany  z 
pierwszym  elementem  tablicy. począwszy od
